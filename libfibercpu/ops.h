...
enum SpecializedOp : uint16_t {
    ...
    OP_FUSED_CMP_EVIB_JE_REL32 = 0x206,
    OP_FUSED_CMP_EVIB_JNE_REL32 = 0x207,
    OP_FUSED_TEST_EVGV_JE_REL8 = 0x208,
    OP_FUSED_TEST_EVGV_JNE_REL8 = 0x209,
    OP_FUSED_TEST_EVGV_JE_REL32 = 0x20A,
    OP_FUSED_TEST_EVGV_JNE_REL32 = 0x20B,
    OP_FUSED_CMP_EVGV_JE_REL8 = 0x20C,
    OP_FUSED_CMP_EVGV_JNE_REL8 = 0x20D,
    OP_FUSED_CMP_EVGV_JE_REL32 = 0x20E,
    OP_FUSED_CMP_EVGV_JNE_REL32 = 0x20F,
    OP_FUSED_CMP_GVEV_JE_REL8 = 0x210,
    OP_FUSED_CMP_GVEV_JNE_REL8 = 0x211,
    OP_FUSED_CMP_GVEV_JE_REL32 = 0x212,
    OP_FUSED_CMP_GVEV_JNE_REL32 = 0x213,
};
