...
public class EpollInode : TmpfsInode
{
    ...
    private void CheckAndRegisterLocked(EpollItem item)
    {
        ...
        short mask = (short)(watchEvents | Fiberish.Native.LinuxConstants.EPOLLERR | Fiberish.Native.LinuxConstants.EPOLLHUP);
    ...
    public class EpollAwaiter : System.Runtime.CompilerServices.INotifyCompletion
    {
        ...
        private void DoPoll()
        {
            ...
            _inode._waitQueue.Register(ScheduleRePoll, _task);
        }
    }
