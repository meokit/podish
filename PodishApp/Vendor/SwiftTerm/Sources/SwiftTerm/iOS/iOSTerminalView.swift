...
open class TerminalView: UIScrollView, UITextInputTraits, UIKeyInput, UIScrollViewDelegate, TerminalDelegate, UIPointerInteractionDelegate {
    ...
    override public func draw (_ dirtyRect: CGRect) {
        ...
        // Force a deterministic clear/fill pass for the dirty rect.
        // Using normal alpha blending with a transparent background can leave
        // stale pixels behind on iOS during rapid scroll/redraw sequences.
        context.saveGState()
