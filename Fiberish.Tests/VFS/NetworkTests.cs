...
public class NetworkTests
{
    ...
    public void EpollInode_ShouldRegisterAndTriggerEvents()
    {
        ...
        var file = new Fiberish.VFS.LinuxFile(fileDentry, FileFlags.O_RDWR | FileFlags.O_NONBLOCK, null!);
    ...
    public async Task UnixSocketInode_ShouldPassDataAndFds()
    {
        ...
        var dummyFile = new Fiberish.VFS.LinuxFile(new Dentry("d", dummyFdNode, null, env.MemfdSuperBlock),
