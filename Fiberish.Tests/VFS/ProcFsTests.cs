...
public class ProcFsTests
{
    ...
    public void ProcPidSymlinksAndFd_ShouldExposeExeCwdRootFdAndFdinfo()
    {
        ...
        try
        {
            ...
            exeProp!.SetValue(process, FsEncoding.EncodeUtf8("/bin/test-app"));
    ...
    public void ProcMemInfo_ShouldUseLiveMemoryStats()
    {
        ...
        {
            Assert.True(
                ctx.SyscallManager.MemoryContext.BackingPagePool.TryAllocAnonPageMayFail(out allocated,
    ...
    private static KernelRuntime CreateTmpfsProcRuntime()
    {
        return KernelRuntime.BootstrapWithRoot(false, sys =>
        {
            ...
            var rootSb = tmpfsType.CreateAnonymousFileSystem(sys.MemoryContext)
                .ReadSuper(tmpfsType, 0, "proc-test-root", null);
