...
void OpShld_EvGvIb(EmuState* state, DecodedOp* op) {
...
void OpShld_EvGvCl(EmuState* state, DecodedOp* op) {
...
// dest = (dest >> count) | (src << (32 - count))
void OpShrd_EvGvIb(EmuState* state, DecodedOp* op) {
...
void OpShrd_EvGvCl(EmuState* state, DecodedOp* op) {
